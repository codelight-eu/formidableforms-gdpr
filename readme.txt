...
The easiest way to make your Formidable Forms GDPR-compliant GDPR compliant!

This plugin adds new privacy features to Formidable Forms. Your visitors can download or delete their form submissions automatically or submit a request for the site admin to do so.
...
### Documentation
How to use this plugin (practical guide): [Making your Formidable Forms GDPR-compliant](https://codelight.eu/wordpress-gdpr-framework/guide/making-your-forms-compliant/)
